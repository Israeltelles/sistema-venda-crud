...
if (isset($_POST['submit'])) {
    ...
    $tipo_conta = filter_input(INPUT_POST, 'tipo_conta', FILTER_SANITIZE_STRING);
    $senha      = filter_input(INPUT_POST, 'senha', FILTER_SANITIZE_STRING);
    

    $result = mysqli_query($conexao, 
        "INSERT INTO clientes 
        (nome_completo, email, telefone, sexo, data_nascimento, cidade, estado, endereco, tipo_conta, data_cadastro, senha) 
        VALUES 
        ('$nome', '$email', '$telefone', '$sexo', '$data_nasc', '$cidade', '$estado', '$endereco', '$tipo_conta', NOW(), '$senha')");
